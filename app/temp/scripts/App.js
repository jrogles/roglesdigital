...
var _LazyScroll = __webpack_require__(2);

var _LazyScroll2 = _interopRequireDefault(_LazyScroll);

var _ContactForm = __webpack_require__(5);

var _ContactForm2 = _interopRequireDefault(_ContactForm);

var _Typekit = __webpack_require__(6);

var _Typekit2 = _interopRequireDefault(_Typekit);

var _ConsoleFallback = __webpack_require__(7);

var _ConsoleFallback2 = _interopRequireDefault(_ConsoleFallback);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var lazyScroll = new _LazyScroll2.default();
var contactForm = new _ContactForm2.default();
var typeKit = new _Typekit2.default();
var consoleFallback = new _ConsoleFallback2.default();
...
var LazyScroll = function () {
  function LazyScroll() {
    ...
    this.lazy = (0, _jquery2.default)(".lazyload");
    this.hlinks = (0, _jquery2.default)(".header__nav a");

    this.addSmoothScroll();
    this.refreshWaypoints();

    this.itemsToReveal = (0, _jquery2.default)(".lazyload");
    this.waypointOffset = "85%";
    this.hideInit();
    this.createWaypoints();
  }

  _createClass(LazyScroll, [{
    key: 'hideInit',
...
var ConsoleFallback = function () {
    function ConsoleFallback() {
        _classCallCheck(this, ConsoleFallback);

        this.init();
    }

    _createClass(ConsoleFallback, [{
        key: 'init',
        value: function init() {
...
exports.default = ConsoleFallback;
